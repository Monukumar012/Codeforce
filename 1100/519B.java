...
public class Main{
    ...
    static void solve(){
        ...
        for(int i=0;i<n;i++)aSum+=sc.nextLong();
        for(int i=1;i<n;i++)bSum+=sc.nextLong();
        for(int i=2;i<n;i++)cSum+=sc.nextLong();
        System.out.println(aSum-bSum);
        System.out.println(bSum-cSum);

        // int arr[]=sc.nextIntArray(n);
        // int brr[]=sc.nextIntArray(n-1);
        // int crr[]=sc.nextIntArray(n-2);
        // Arrays.sort(arr);Arrays.sort(brr);Arrays.sort(crr);
        // int i=0;
        // while(i<n-1){
        //     if(arr[i]!=brr[i]){
        //         out.println(arr[i]);
